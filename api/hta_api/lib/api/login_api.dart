...
class LoginApi {
  ...
  Future<Response> oidcInfoGetWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/oidc_info';
  ...
  /// Obtain information about OpenID Connect
  Future<OidcInfo?> oidcInfoGet() async {
    final response = await oidcInfoGetWithHttpInfo();
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OidcInfo',) as OidcInfo;
